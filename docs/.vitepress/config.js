...
export default {
  ...
  themeConfig: {
    ...
    // 编辑链接
    editLink: {
      pattern: "https://github.com/BMHX/vitepress_blog",
      text: "在 github 上编辑此页",
    },
    // 站点页脚配置
    footer: {
      // message: "Released under the MIT License",
      copyright: "Copyright © 2023-present Zhi jie",
    },
    // 社交和项目链接地址配置
    socialLinks: [
      { icon: "github", link: "https://github.com/BMHX/vitepress_blog" },
      // 也可以自定义svg的icon:
      // {
      //   icon: {
  ...
  vite: {
    build: {
      chunkSizeWarningLimit: 2000,  // 提高 chunk 大小的警告限制
      rollupOptions: {
        output: {
          manualChunks(id) {
            if (id.includes('node_modules')) {
              return 'vendor'; // 将 node_modules 中的依赖打包到 vendor.js
            }
          },
        },
      },
